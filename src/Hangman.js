  ...
  gameOver() {
    // if(this.props.maxWrong) {
      ...
      return (
        ...
        <button className="Hangman-start-button" onClick={this.startGame}>Start over</button>
        </div>
      )
    // }
  }
  ...
  render() {
    ...
    return (
      <div className='Hangman'>
        ...
        <p>Number of wrong: {this.state.nWrong >= this.props.maxWrong ? ` You reached ${this.props.maxWrong} guesses ` : this.state.nWrong}</p>
